# openScience
describe tips and tricks to make a scientific production open reproducible and collaborative
...
we build and exploit a Virtual Research Environement (VRE) via [jupyterlab](https://jupyter.org/)
...
Lessons	
1	Introduction – What is Open Science – What is a VRE – Examples 
2	Sharing – Code – Jupyter – Information Hunting – Articles – Codes – Hyphothesis - 
3	Stack OverFlow – Nbviewer – Git Hub – diff merging skills …
4	
